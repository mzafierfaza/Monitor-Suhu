...
<body>
    <div style="text-align:center;"><b>Monitoring Suhu dan Kelembapan</b><br>Real Time Data Humidity, Temperature Logging with Graphs on ESP8266</div>
    <div class="chart-container" position: relative; height:350px; width:100%">
        <canvas id="Chart" width="400" height="400"></canvas>
    </div>
<div>
  <table id="dataTable">
    <tr><th>Date</th><th>Time</th><th>Suhu (&deg;C)</th><th>Kelembapan (%)</th></tr>
  </table>
</div>
<br>
<br>  
